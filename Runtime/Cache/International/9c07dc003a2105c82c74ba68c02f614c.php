...
var _ROOT_ = '/SIS.JXNU-B',
    ...
    _ACTION_ = '/SIS.JXNU-B/index.php/International/International/all',
    _MODULE_ = '/SIS.JXNU-B/index.php/International',
    _CONTROLLER_ = '/SIS.JXNU-B/index.php/International/International';
</script>
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
