...
var _ROOT_ = '/SIS.JXNU-B',
    ...
    _ACTION_ = '/SIS.JXNU-B/index.php/QuestionCategory/QuestionCategory/all',
    _MODULE_ = '/SIS.JXNU-B/index.php/QuestionCategory',
    _CONTROLLER_ = '/SIS.JXNU-B/index.php/QuestionCategory/QuestionCategory';
</script>
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
