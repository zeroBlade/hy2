      ...
      <ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <br/><br/><br/><br/><br/>
                    <hr/>
                        <?php echo ($one_course['auxiliary_teaching']); ?>
                    </article>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/contact',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/contact/course_id/150.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
