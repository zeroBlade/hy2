 ...
 <ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <br/><br/><br/><br/><br/>
                    <hr/>
                    <h4 class="text-center">作业习题</h4><br/>
                    <div class="pull-right">发布时间: <span><?php echo ($one_course['create_time']); ?></span> &nbsp;&nbsp;查看：<span><?php echo ($one_course['hit']); ?></span>次 </div>
                    <br/>
                    <!--<article><p>-->
                    <!--&lt;!&ndash;   <span style="border-left: 3px solid green;font-size: 20px;margin-right: 10px;">&nbsp作业文件</span> &ndash;&gt;-->
                      <!--<ul style="margin-left: 20px;list-style:none;">-->
                        <!--<li ><span style="font: 15px"></span> &nbsp; &nbsp; <a href="/SIS.JXNU-B/Public/uploads/<?php echo ($homeWork['savepath']); echo ($homeWork['savename']); ?>" style="color: black;"> <?php echo ($homeWork['name']); ?></a>-->
                         <!--</li>-->
                      <!--</ul>-->
                    <!--</p></article>-->
                    <article><pre><?php echo ($one_course['homework']); ?></pre></article>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/homeWork',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/homeWork/course_id/150.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
