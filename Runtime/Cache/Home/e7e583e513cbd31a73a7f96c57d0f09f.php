        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <br/><br/><br/><br/><br/>
                    <hr/>
                    <h4 class="text-center">视频素材</h4><br/>
                    <div class="pull-right">创建时间: <span><?php echo ($one_course['create_time']); ?></span> &nbsp;&nbsp;观看：<span><?php echo ($one_course['hit']); ?></span>次 </div>
                    <br/>
                    <article>
                      <p> <?php if(empty($one_course['video_footage'])): ?>暂无视频素材<?php else: ?> <?php echo ($one_course['video_footage']); endif; ?> </p>
                    </article>
                </div>
            </div>
        </div>
