...
<!-- /.navbar-collapse -->
    ...
    <ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <div class="col-md-12 col-xs-12">
                        <ol class="my-breadcrumb">
                            <li><a href="<?php echo U('Index/index');?>">首页</a></li>
                            <li>精品课程</li>
                            <li title="<?php echo ($course_name); ?>"><?php echo ($course_name); ?></li>
                            <li>课程团队
                            </li>
                        </ol>
                    </div>
                ...
                <article> <pre><?php echo ($one_course['course_team']); ?></pre></article>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/teachers',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/teachers/course_id/150.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
