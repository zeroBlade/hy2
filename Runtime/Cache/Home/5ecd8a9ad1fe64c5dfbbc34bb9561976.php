    ...
    <ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <br/><br/><br/><br/><br/>
                    <hr/>
                    <article><?php echo ($one_course['couser_calendar']); ?></article>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/calendar',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/calendar/course_id/162.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
