        ...
        <div class="row">
            <div class="page-body-left col-md-3">
                ...
                <?php if(empty($course_id)): ?><div class="side-nav">
                        <ul>
                            <?php if(empty($session_id)): ?><a href="<?php echo U('Question/questionList');?>">
                                    <li class="active">
            ...
            <div class="page-body-right col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <?php if(empty($all_question)): ?><div class=" empty_my_question alert alert-info">还没有人提问哦！快去抢沙发~</div>

                            <?php else: ?>
                            <div class="form-body">
                                <div class="panel-group"  id="accordion" role="tablist" aria-multiselectable="true">
                                    <?php if(is_array($all_question)): $i = 0; $__LIST__ = $all_question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default ql-panel">
                            ...
                            <div class="page-div">
                                <div class="col-md-12 col-xs-12"> <?php echo ($page); ?> </div>
                            </div><?php endif; ?>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/Question/questionList',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/Question/questionList.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
