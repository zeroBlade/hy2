    ...
    <div class="container">
        <div class="row">
          ...
          <ul>
                              ...
                              <span class="after"></span>
                              <a href="<?php echo U('GoodCourse/video',array('course_id'=>$one_course['id']));?>">
                                  <li>
                              ...
                              <a href="<?php echo U('Question/askQuestion',array('course_id'=>$one_course['id']));?>">
                                  <li>
                                  <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text">课程提问</span>
                                  </li>
                              </a>
                              <span class="after"></span>
                          </ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <br/><br/><br/><br/><br/>
                    <hr/>
                    <h4 class="text-center">音频素材</h4><br/>
                    <div class="pull-right">创建时间: <span><?php echo ($one_course['create_time']); ?></span> &nbsp;&nbsp;下载：<span><?php echo ($one_course['hit']); ?></span>次 </div>
                    <br/>
                     <article><?php echo ($one_course['audio']); ?></article>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/vedio',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/vedio/course_id/162.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
