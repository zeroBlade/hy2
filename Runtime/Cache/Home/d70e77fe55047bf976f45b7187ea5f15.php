   ...
   <ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <br/><br/><br/><br/><br/>
                    <hr/>
                    <article><?php if(empty($one_course['video_teach'])): ?>暂无内容<?php else: ?> <?php echo ($one_course['video_teach']); endif; ?></article>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/video_watch',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/video_watch/course_id/150.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
