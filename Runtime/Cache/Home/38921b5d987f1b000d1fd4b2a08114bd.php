    ...
    <ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <br/><br/><br/><br/><br/>
                    <hr/>
                    <!--<article><a href="/SIS.JXNU-B/Public/uploads/<?php echo ($a[0]['savepath']); echo ($a[0]['savename']); ?>" style="color:black;"><?php echo ($a[0]['name']); ?></a></article>-->
                    <article><?php echo ($one_course['courseware']); ?></article>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var _ROOT_ = '/SIS.JXNU-B',
            ...
            _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/courseware',
...
<script type="text/javascript">
    ...
    window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/courseware/course_id/150.html");?>';
</script>
<!-- BEGIN CORE SCRIPTS -->
